...
```sql
CREATE DATABASE mum_mentor_ai;
```
🔹 **Replace:**  
- `mum_mentor_ai` → Your **preferred database name** (e.g., `fastapi_db`).  
...
```sql
GRANT ALL PRIVILEGES ON DATABASE mum_mentor_ai TO user;
```
🔹 **Replace:**  
- `mum_mentor_ai` → The **database name you used** in Step 2.  
- `user` → The **username you created** in Step 1.  

✅ **Example:**  
```sql
GRANT ALL PRIVILEGES ON DATABASE mum_mentor_ai TO fastapi_user;
```
...
```env
DATABASE_URL=postgresql://user:your_password@localhost/mum_mentor_ai
```
🔹 **Replace:**  
- `user` → Your **database username**.  
- `your_password` → Your **database password**.  
- `mum_mentor_ai` → Your **database name**.  

✅ **Example:**  
```env
DATABASE_URL=postgresql://fastapi_user:StrongP@ssw0rd@localhost/mum_mentor_ai
```
...
```sh
psql -U user -d mum_mentor_ai -h localhost
```
🔹 **Replace:**  
- `user` → Your **database username**.  
- `mum_mentor_ai` → Your **database name**.  
...
✅ **Example:**  
```sh
psql -U fastapi_user -d mum_mentor_ai -h localhost
```
